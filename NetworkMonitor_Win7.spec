...
a = Analysis(
    ...
    binaries=[],
    datas=datas,
    hiddenimports=['aiosqlite', 'apscheduler.triggers.interval', 'uvicorn.logging', 'uvicorn.loops', 'uvicorn.loops.auto', 'uvicorn.protocols', 'uvicorn.protocols.http', 'uvicorn.protocols.http.auto', 'uvicorn.protocols.websockets', 'uvicorn.protocols.websockets.auto', 'uvicorn.lifespan', 'uvicorn.lifespan.on', 'pysnmp.smi.mibs', 'pysnmp.smi.exval', 'pysnmp.carrier.asyncio.dgram.udp', 'anyio._backends._asyncio', 'fpdf', 'snmp_engine', 'psutil', 'tracemalloc'],
    hookspath=[],
    hooksconfig={},
    runtime_hooks=[],
    excludes=[],
